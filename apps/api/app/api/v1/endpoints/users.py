...
from sqlalchemy import select # SQLAlchemy’s select() for building DB queries.
from sqlalchemy.ext.asyncio import AsyncSession # Async DB session type for SQLAlchemy.

from infrastructure.db.models.user import User # Imports ORM model mapped to users table. Query is executed against this model
